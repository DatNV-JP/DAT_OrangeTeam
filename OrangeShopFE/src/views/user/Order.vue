...
import TabPane from '@/views/tab/components/TabPane-2'
  ...
  data() {
    return {
      ...
      tabMapOptions: [
        ...
        { label: 'Chờ xác nhận', key: '5' },
        { label: 'Xác nhận', key: '6' },
        { label: 'Đang giao hàng', key: '4' },
        { label: 'Đã nhận hàng', key: '1' },
        { label: 'Chờ hủy', key: '7' },
        { label: 'Đã hủy', key: '2' },
        { label: 'Chờ xác nhận hoàn trả', key: '9' },
        { label: 'Hoàn trả', key: '8' }
      ],
      activeName: '0'
    }
  },
